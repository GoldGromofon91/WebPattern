...
from settings.settings import Application, Logger, Debug, MapperRegistry
...
from settings.architec_pat import UnitOfWork
...
class CourseApi:
    ...
    def __call__(self, request):
        return '200 OK', BaseSerializer(site.meetup).save()
